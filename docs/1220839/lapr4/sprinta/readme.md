# 1220839 - Vasco Teixeira - Sprint A - Self Assessment
...
**Justification and Evidences:** Everything requested is documented.
...
**Justification and Evidences:** Overall, I think we managed the issues well, with most of the messages being very clear.
...
**Justification and Evidences:** I think the work was well distributed. In this sprint, all the US's were global, with all the members participating in all the user stories.
...
**Justification and Evidences:** The system runs outside the IDE, and the group was able to demonstrate the system without faults. Some members of the group only have local java problems.
...
**Justification and Evidences:** All the necessary applications are integrated, with the various components having the desired connection established.
...
**Justification and Evidences:** The team fulfilled all the requirements that were proposed and respected the appropriate acceptance criteria.