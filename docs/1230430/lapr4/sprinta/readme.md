# 1230430 - Eduardo Ferreira - Sprint A - Self Assessment
...
**Justification and Evidences:** Generally we have used correct commit messages and good practice patterns with issues connection, but, sometimes we have forgotten to apply it.  
...
**Selected Level:** 4 All the work was well distributed but there is no specific documentation of child-issues and who worked on them.
...
**Justification and Evidences:** The system runs at different machines locally and there is a remote testing, but there are problems with some members local machines.
...
**Justification and Evidences:** All the apps required are integrated into the same aggregate, the connection between components is established. 
...
**Justification and Evidences:** The group met all the requirements proposed and fulfilled all the acceptance criteria.